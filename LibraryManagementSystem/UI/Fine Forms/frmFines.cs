...
namespace LibraryManagementSystem.UI.Report_Forms
{
    public partial class frmAllFines : WeifenLuo.WinFormsUI.DockContent
    {
        ...
        private void btnPay_Click(object sender, EventArgs e)
        {
            ...
            {
                ep.SetError(txtFinePay, "Fine amount cannot be left empty!");
                txtFinePay.Focus();
                return;
            }
            ...
            if (Convert.ToInt32(txtFinePay.Text) <= (f.FineAmount + f.RecivedAmount))
            {
                ...
                MessageBox.Show("Fine update successful.", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Information);
                FillGridFines();
            }
            else
            {
                MessageBox.Show("The amount entered exceeds the remaining fine amount for this student ID.", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
