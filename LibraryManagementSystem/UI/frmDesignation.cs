...
namespace LibraryManagementSystem.UI
{
    public partial class frmDesignation : WeifenLuo.WinFormsUI.DockContent
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please enter the designation name!", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            MessageBox.Show("Designation added successfully", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Information);
            FillGrid();
        }
    }
}
