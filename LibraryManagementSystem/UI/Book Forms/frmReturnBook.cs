    ...
    public partial class frmReturnBook : WeifenLuo.WinFormsUI.DockContent
    {
        ...
        private void btnSearchStudent_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("No books found for this student ID.", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            catch (Exception ex)
            {
        ...
        private void btnReturnBook_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Book return successful!", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Information);
            DisableComponent();
        }
        ...
        private void btnSelectIssueBook_Click(object sender, EventArgs e)
        {
            ...
            if (DateTime.Now > ib.DateOfReturn)
            {
                int days = Convert.ToInt32((DateTime.Now - ib.DateOfReturn).TotalDays);
                txtTotalDay.Text = days.ToString();

                int fine = Convert.ToInt32(txtFinePerDay.Text);

                int totalAmount = days * fine;
