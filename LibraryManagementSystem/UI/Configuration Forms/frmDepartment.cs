...
namespace LibraryManagementSystem.UI.Configuration_Forms
{
    public partial class frmDepartment : WeifenLuo.WinFormsUI.DockContent
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please enter the department name!", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            if (!DepartmentsHelper.HaveDepartmentName(txtDepartmentName.Text))
            {
                ...
                MessageBox.Show("Department added successfully", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Information);
                FillGrid();
            }
            else
            {
                MessageBox.Show("A department with the same name already exists!", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                if (dgvDepartmentList.Rows.Count > 0)
                {
                    ...
                    {
                        DialogResult dialogResult = MessageBox.Show("Are you sure you want to delete the department?", "Library Management System", MessageBoxButtons.YesNo);
                    ...
                    {
                        MessageBox.Show("Please select the department you want to delete!", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    }
                }
                else
                {
                    MessageBox.Show("Department list is empty!", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
            catch (Exception ex)
            {
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Department list is empty!", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        {
            epProgram.Clear();
            bool check = DepartmentsHelper.ControlValidate(txtDepartmentName, "Please enter the department name.", epProgram);
            ...
            if (check)
            {
                ...
                MessageBox.Show("Department updated successfully", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Information);
                ClearForm();
                FillGrid();
                DisableComponent();
            }
