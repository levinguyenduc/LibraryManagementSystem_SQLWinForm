...
namespace LibraryManagementSystem.UI.Configuration_Forms
{
    public partial class frmBookCategory : WeifenLuo.WinFormsUI.DockContent
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                ep.SetError(txtBookType, "Book category cannot be empty!");
                txtBookType.Focus();
                return;
            }
            ...
            MessageBox.Show("Book Category Added Successfully", "Library Management System", MessageBoxButtons.OK, MessageBoxIcon.Information);
